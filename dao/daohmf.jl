...
export get_linear_power, diffusion_damp, kd, dao, zRec, saha, zDec, sharpk, σ, shethtormensk, dndmsharpk
...
function get_linear_power(p, zvals, Ωb=Ωb)
    ...
    println("σ_8: $(results.get_sigma8())")
    println("σ_R: $(results.get_sigmaR(R= 8, hubble_units=false))")
...
# MR: These have already been defined above
